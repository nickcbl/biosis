...
* A relação gene-proteína-reação ( GPR ) deve ser encontrada.
  ...
  * Exemplos
    ...
    * A  ssim sdhA   E sdhB   E sdhC   E sdhD são necessário para a reação.
...
![](img/07-Rede-Metabolica_6.png){.r-stretch fig-align="center"}
...
(0.03) Polímero de Peptidoglicano (n-1 subunidades) + (0) Apo-ACP + (0) Dimetilbenzimidazol + (1.00)  BIOMASSA  + (40.00) Fosfato + (40.00) ADP + (40.00) H⁺ + (0.48) Pirofosfato + (0) Cobinamida
