...
:::{layout-ncol="2"}
![Force-Directed](img/02-Grafos_28.png){width="100%" height="600px" style="object-fit: contain;"}

![Hierárquico](img/02-Grafos_29.png){width="100%" height="600px" style="object-fit: contain;"}

[yfiles: simulação de redes](https://www.yfiles.com/demos/showcase/layoutstyles/index.html)
:::
### Circular e Radial
:::{layout-ncol="2"}
![Circular](img/02-Grafos_30.png){width="100%" height="600px" style="object-fit: contain;"}

![Radial](img/02-Grafos_31.png){width="100%" height="600px" style="object-fit: contain;"}
...
::: {.column}
![](img/02-Grafos_32.png){.r-stretch fig-align="center"}
:::
...
::: footer
[Referência: Figura](https://www.wolfram.com/mathematica/new-in-8/graph-and-network-analysis/find-an-isomorphism.html.pt-br)
:::
...
<iframe src="v2-simulador_grafos.html" width="100%" height="900px" style="object-fit: contain;">
</iframe>

# Simulador de Redes

<iframe src="v2-simulador_redes.html" width="100%" height="900px" style="object-fit: contain;">
</iframe>