...
* Uma rede de co-expressão gênica pode ser construída procurando pares de genes que mostram:
  * P  adrão de expressão similar entre amostras , já que os níveis de  transcrição de dois genes co-expressos podem subir ou descer juntos em amostras .
...
O pacote de clustering mais usado para a análise de redes co-expressão é o Análise Ponderada de Rede de Correlação de Genes ( WGCNA ,  _W_  _eighted _  _G_  _ene _  _C_  _o-expression _  _N_  _etwork _  _A_  _nalysis_ ).
